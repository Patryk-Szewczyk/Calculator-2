    ...
    setButtons_AEL: function () {
        ...
        for (var i = 0; i < button_COLL.length; i++) {
            button_COLL[i].addEventListener("click", function (e) {
                ...
                // Usunięcie wyniku:
                console.log("TEST:");
                console.log(_this.bt_ID != "=");
                console.log(_this.isLogicResult == true);
                console.log("----------------------");
                if (_this.bt_ID != "=" && _this.isLogicResult == true) {
                    _this.isLogicResult = false;
                    _this.operation_AC();
                }
            }, false);
        }
...
var Calculator_Euklides_FUNCTIONS = {
    ...
    operation_EUK: function () {
        ...
        // Algorytm euklidesa:
        var fixed_A = Number(baseNum_AR[0]), fixed_B = Number(baseNum_AR[1]);
        var a_LEFT = Number(baseNum_AR[0]), b_RIGHT = Number(baseNum_AR[1]);
